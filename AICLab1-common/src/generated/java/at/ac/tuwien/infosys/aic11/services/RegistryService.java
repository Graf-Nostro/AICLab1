 ...
 * 2011-11-12T07:49:13.634+01:00
 * Generated source version: 2.5.0
 * 
 */
@WebServiceClient(name = "Registry_Service", 
                  wsdlLocation = "file:/home/fader/workspace/AICLab1/AICLab1-common/src/main/wsdl/registry_service.wsdl",
...
public class RegistryService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/fader/workspace/AICLab1/AICLab1-common/src/main/wsdl/registry_service.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RegistryService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/fader/workspace/AICLab1/AICLab1-common/src/main/wsdl/registry_service.wsdl");
        }
        WSDL_LOCATION = url;
    }
